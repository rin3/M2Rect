...
#
# rin fukuda, rin@jg1vgx.net, Mar 2006
# ver 0.03
...
open FD, ">bandchanges.txt" or die "Can't create bandchange file!\n";
open FR, ">qsy_report.txt" or die "Can't create qsy report file!\n";

my @qsos;	# original qso array read from source
my @qsox;	# working qsy array
my $lastline;
...
while(<F>) {
	...
	if(/^QSO: /) {
		...
		# keep lastline for later footer output
		$lastline = $_;
		last;
	}
}
